...
fetch('https://api.github.com/repos/Ilya-Avd/My-works/contents/Test/data.json')
    ...
    const parsedData = JSON.parse(content).map((item) => ({
        'Id': item.id,
    ...
    function formEdit(element) {
        ...
        let tdValues = Array.from(eEdit.children).map((td) => { var _a; return (_a = td.textContent) !== null && _a !== void 0 ? _a : ''; });
        ...
        buttn.onclick = function () {
            ...
            dropForm === null || dropForm === void 0 ? void 0 : dropForm.remove();
            updateTable();
        };
        //Добавление 
    ...
    function hideColumn() {
        ...
        headers_btn.forEach(heade_Text => {
            ...
            btn.addEventListener('click', function () {
                const elementsToHide = document.querySelectorAll('.' + btn.innerText);
